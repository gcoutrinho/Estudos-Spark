...
public class DesafioSpark {
	...
	public static void main(String args[]) {
         ...
         JavaRDD<String> rddAugust = ctx.textFile("C:/access_log_Aug95");
         JavaRDD<String> rddJuly = ctx.textFile("C:/access_log_Jul95");
	...
	public static void retornaErros404PorDia(JavaRDD<String> unionRDD) {
		...
		JavaPairRDD<String, Integer> filtered = errosFiltrados
				.mapToPair(m -> new Tuple2<String, Integer>(m.split("-.-\\w|\\[|\\]|\"| ")[4].split(":")[0], 1));
